...
export function PricingSection() {
  return (
    <section id="pricing" className="section-padding bg-white dark:bg-dark-background">
        ...
        <div className="space-y-16">
          ...
          >
            ...
            <p className="text-xl text-gray-600 dark:text-white max-w-3xl mx-auto leading-relaxed">
              Get exclusive early access to the revolutionary SARAS Engine at a special launch price. 
              Limited time offer for visionary fitness enthusiasts.
            </p>
          </motion.div>
              ...
              {pricingPlans.map((plan, index) => (
                ...
                >
                  ...
                  <Card 
                    ...
                    style={{
                      boxShadow: '0 0 50px rgba(0, 0, 0, 0.1), 0 25px 50px -12px rgba(0, 0, 0, 0.25)'
                    }}
                  >
                      ...
                      <ul className="space-y-4">
                        {plan.features.map((feature, featureIndex) => (
                          <li key={featureIndex} className="flex items-start space-x-3">
                            ...
                            <span className="text-gray-700 dark:text-white font-medium">{feature}</span>
                          </li>
                        ))}
                      </ul>
          ...
          >
            <div className="bg-white dark:bg-black border border-black/20 dark:border-white/20 rounded-2xl p-6 max-w-2xl mx-auto">
              ...
              <p className="text-gray-700 dark:text-white">
                Lock in this exclusive rate of $9.99/month while we're in early access. 
                Price increases to $29.99/month after launch. Your rate stays locked forever.
              </p>
            </div>
