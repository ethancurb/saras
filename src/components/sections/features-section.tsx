...
const mainFeatures: FeatureItem[] = [
  {
    ...
    description:
      'The SARAS Engine analyzes your unique patterns, preferences, and progress to create truly personalized fitness experiences that evolve with you.',
    icon: Brain,
    highlight: true,
  },
  {
    ...
    description:
      'SARAS learns from every workout, recovery metric, and performance metric to refine your program in real time.',
    icon: TrendingUp,
    highlight: true,
  },
  {
    ...
    description:
      'Your AI trainer never sleeps. Get instant guidance, workout generation, and advanced performance and recovery analysis, whenever you need it, day or night.',
    icon: Clock,
    highlight: true,
  },
];
        ...
        <div className='space-y-16'>
          ...
          >
            ...
            <p className='text-xl text-gray-600 dark:text-white max-w-3xl mx-auto leading-relaxed'>
              ...
              Where AI intelligence meets user-centric experience to deliver
              ...
              <Card variant='default' size='lg' className='space-y-6'>
                ...
                <CardContent className='space-y-4'>
                  {comparisonFeatures.map((item, index) => (
                    <div
                      key={index}
                      className='flex items-start space-x-3 p-3 bg-black/5 dark:bg-white/5 rounded-lg'
                    >
